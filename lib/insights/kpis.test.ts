...
describe("computeSurplusRateKpi", () => {
  it("names the biggest outgoing category as the drain", () => {
    const transactions: CategorizedTransactionFixture[] = [
      { date: d("2026-08-01"), amount: 3000, direction: "IN", category: "Salary" },
      { date: d("2026-08-01"), amount: 1200, direction: "OUT", category: "Rent" },
      { date: d("2026-08-02"), amount: 400, direction: "OUT", category: "Groceries" },
    ];
...
describe("buildSurplusRateDrillDown", () => {
  it("caps entries at 20 for a long range without breaking the series/summary", () => {
    const transactions: CategorizedTransactionFixture[] = [{ date: d("2026-06-01"), amount: 1000, direction: "IN", category: "Salary" }];
